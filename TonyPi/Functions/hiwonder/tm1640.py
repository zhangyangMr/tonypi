...
clkPin = chip.get_line(8)
clkPin.request(consumer="clk", type=gpiod.LINE_REQ_DIR_OUT)

dioPin = chip.get_line(7)
dioPin.request(consumer="dio", type=gpiod.LINE_REQ_DIR_OUT)
...
class TM1640(object):
    ...
    def dio(self, n_s):
        dioPin.set_value(n_s)

    def clk(self, n_s):
        clkPin.set_value(n_s)
