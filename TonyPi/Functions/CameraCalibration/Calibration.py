...
#开始标定, 按任意键关闭最后的图像显示(start calibration. Press any key to close the final image display)
...
#标定采集的图像存储路径(the storage path for collected calibration images)
...
#读取第10张图片测试矫正(read the 10th image to test the correction)
